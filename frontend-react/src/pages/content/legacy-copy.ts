    ...
    cases: {
      cards: [
        ...
        },
        {
          ...
          body: 'Ang Lee’s film used AI to build a fully synthetic younger clone of Will Smith. Every pore and blink was generated from motion-captured emotion — a human reborn in pixels.',
        },
        {
          category: 'AI Consciousness',
          body: 'Though not VFX-based, <em>Her</em> explores emotional AI through voice. The unseen digital being becomes more human than humans — showing that cinema can simulate love itself.',
        },
        {
          category: 'Synthetic Emotions',
          body: 'Joi, the holographic companion, was created with AI-driven volumetric lighting and emotional simulation. The character questions what is more real — programmed affection or human loneliness.',
        },
        {
          category: 'AI Video Generation',
          body: 'OpenAI’s Sora can generate cinematic sequences from text — lighting, movement, and atmosphere. It marks the dawn of AI filmmaking where imagination itself directs the scene.',
        },
        {
          category: 'Deepfake Ethics',
          body: 'Documentary filmmakers used deepfake AI to protect activists’ identities, demonstrating how technology can balance safety and truth in storytelling.',
        },
      ],
    },
  },
  kk: {
    ...
    cases: {
      cards: [
        ...
        {
          category: 'Цифрлық егіз',
          body: 'Ang Lee фильмі Will Smith-тің толық синтетикалық жас клонын жасау үшін AI қолданды. Әрбір тері порасы мен көз жыпылықтауы motion capture эмоциясынан генерацияланды — адам пиксельдерде қайта туғандай.',
        },
        {
          category: 'AI санасы',
          body: 'VFX-ке негізделмесе де, <em>Her</em> дауыс арқылы эмоциялық AI идеясын зерттейді. Көрінбейтін цифрлық болмыс адамдардан да адамға ұқсап кетеді — кино махаббаттың өзін симуляциялай алатынын көрсетеді.',
        },
        {
          category: 'Синтетикалық эмоциялар',
          body: 'Голографиялық серік Joi AI негізіндегі көлемдік жарық пен эмоциялық симуляция арқылы жасалды. Кейіпкер қайсысы шынайырақ деген сұрақ қояды — бағдарламаланған сүйіспеншілік пе, әлде адам жалғыздығы ма?',
        },
        {
          category: 'AI видео генерациясы',
          body: 'OpenAI Sora мәтіннен жарық, қозғалыс және атмосферасы бар кинематографиялық көріністер жасай алады. Бұл қиялдың өзі сахнаны бағыттайтын AI filmmaking дәуірінің басталуын білдіреді.',
        },
        {
          category: 'Дипфейк этикасы',
          body: 'Деректі фильм авторлары белсенділердің жеке басын қорғау үшін deepfake AI қолданды. Бұл технология қауіпсіздік пен шындықты сторителлингте тең ұстауға көмектесе алатынын көрсетті.',
        },
      ],
    },
  },
    ...
    cases: {
      cards: [
        ...
        },
        {
          ...
          body: 'Фильм Ang Lee использовал AI для создания полностью синтетического молодого клона Will Smith. Каждая пора и моргание были сгенерированы из motion-captured эмоции — человек, заново рожденный в пикселях.',
        },
        {
          category: 'AI-сознание',
          body: 'Хотя <em>Her</em> не основан на VFX, фильм исследует эмоциональный AI через голос. Невидимое цифровое существо становится человечнее людей, показывая, что кино способно симулировать саму любовь.',
        },
        {
          category: 'Синтетические эмоции',
          body: 'Голографическая спутница Joi была создана с помощью AI-объемного света и эмоциональной симуляции. Персонаж ставит вопрос: что реальнее — запрограммированная привязанность или человеческое одиночество?',
        },
        {
          category: 'AI-генерация видео',
          body: 'OpenAI Sora может генерировать кинематографические сцены из текста — свет, движение и атмосферу. Это начало AI filmmaking, где само воображение режиссирует сцену.',
        },
        {
          category: 'Этика дипфейков',
          body: 'Создатели документального фильма использовали deepfake AI для защиты личностей активистов, показав, как технология может балансировать безопасность и правду в сторителлинге.',
        },
      ],
    },
  },
